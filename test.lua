...
function sandbox:initialize()
  ...
  environment.global.getgenv = function() -- genv brahhh
    return cloned_environment.global
  end

  environment.global.getrenv = function() -- renv rahhhh
  ...
  environment.global.getsenv = function()
    ...
    environment.global.toclipboard = function(data)
        local vim = game:GetService('VirtualInputManager')
        local old = game:GetService("UserInputService"):GetFocusedTextBox()
        local copy = tostring(data)
        local gui = Instance.new("ScreenGui", environment.global.gethui())
	...
	environment.global.getidentity = environment.global.getthreadidentity
        ...
        local identity = 3 -- spoof? cant im sorry
	...
	environment.global.setthreadidentity = function() return true end
	...
	environment.global.setfpscap = function()
		return true
	end



	environment.global.isgameactive = function() -- alliases
		return true
	end
	...
	environment.global.isrbxactive = function() -- it suppose to be return roblox_active but no.
		return true
	end
  ...
  environment.global.readfile = function(f, options)
    ...
    if type(file_content) ~= "string" then
        return error(`Path '{dir_path}' {if type(file_content) == "table" then "is a folder" else "cannot be determined"}`, 0)
    end
    return file_content
  end
  ...
  environment.global.readfile = function(path)
...
-- credits to white cat

function gui:Create()
  local STAUi = Instance.new("ScreenGui")
  ...
  STAUi.Name = "STAUi"
  STAUi.Parent = game.CoreGui
  STAUi.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
  STAUi.DisplayOrder = 10
  STAUi.ResetOnSpawn = false
  ...
  Frame.Size = UDim2.new(0, 942, 0, 333)
  ...
  TextLabel.Position = UDim2.new(0, 0, 0.936936915, 0)
  TextLabel.Size = UDim2.new(1, 0, 0.0630631, 0)
  TextLabel.Font = Enum.Font.GothamMedium
  TextLabel.Text = "creds to white cat for those freaky execute stuff"
  ...
  UIPadding.PaddingBottom = UDim.new(0.219999999, 0)
  ...
  Frame_2.BackgroundColor3 = Color3.fromRGB(230, 230, 230)
  ...
  ButtonList.Position = UDim2.new(0.88542521, 0, 0.111119702, 0)
  ButtonList.Size = UDim2.new(0.114173204, 0, 0.776119411, 0)

  UIGridLayout.Parent = ButtonList
  UIGridLayout.HorizontalAlignment = Enum.HorizontalAlignment.Center
  UIGridLayout.SortOrder = Enum.SortOrder.LayoutOrder
  UIGridLayout.CellPadding = UDim2.new(0.100000001, 0, 0.0299999993, 0)
  ...
  execute.Position = UDim2.new(0.241379306, 0, 0.0192307997, 0)
  execute.Size = UDim2.new(0, 100, 0, 30)
  execute.AutoButtonColor = false
  execute.Image = "rbxassetid://12376668193"
  execute.ImageTransparency = 0.400

  UICorner_3.CornerRadius = UDim.new(0, 4)
  UICorner_3.Parent = execute

  UIAspectRatioConstraint_2.Parent = execute


  UICorner_4.CornerRadius = UDim.new(0, 4)
  UICorner_4.Parent = clear

  UIAspectRatioConstraint_3.Parent = clear
  ...
  local function EIQJV_fake_script() -- execute.LocalScript 
    local script = Instance.new('LocalScript', execute)

    script.Parent.MouseButton1Down:Connect(function()
      sandbox.environment.global.loadstring(script.Parent.Parent.Parent.Frame.ScrollingFrame.TextBox.ContentText)()
    end)
  end
  coroutine.wrap(EIQJV_fake_script)()
  local function FLQIRMQ_fake_script() -- Frame.UIDrag 
  ...
  coroutine.wrap(FLQIRMQ_fake_script)()
  local function KFEK_fake_script() -- STAUi.LocalScript 
    local script = Instance.new('LocalScript', STAUi)
  ...
  coroutine.wrap(KFEK_fake_script)()

  game:GetService("StarterGui"):SetCore("SendNotification", {Text = "injected", Title = "no"})
end
